...
class InsertTest extends TestCase
{
   ...
   public function testInsertUpdate()
   {
       ...
       self::assertEquals(['id' => '1', 'user_id' => '1', 'published_at' => '2011-12-10 12:10:00', 'title' => 'article 1b', 'content' => '1'], $q);
       self::assertEquals('last_inserted_id = 1', "last_inserted_id =". $query2);
       self::assertEquals(['id' => '1', 'user_id' => '1', 'published_at' => '2011-12-10 12:10:00', 'title' => 'article 1', 'content' => 'content 1'], $q2);
   }
